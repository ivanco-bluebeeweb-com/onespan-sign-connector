"""Connection lifecycle for OneSpan Sign Connector."""
...
async def connect_onespan_sign(params: ConnectParams, ctx) -> ActionResult[ConnectionRecord]:
    """Connect OneSpan Sign Connector."""
    ...
    record = {
        "id": cid,
        "label": params.label or "OneSpan Sign Account",
...
@chat.function(
    "list_connections",
    "List connected OneSpan Sign accounts.",
    action_type="read",
    chain_callable=True,
    data_model=NoParams
)
...
@chat.function(
    ...
    "Disconnect OneSpan Sign account.",
    action_type="write",
    chain_callable=True,
