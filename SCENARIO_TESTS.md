# Plausible Scenario Tests (PST) — OneSpan Sign Connector
...
- `connect_onespan_sign`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_onespan_sign`: validated contract & error handling
