"""Settings panel for OneSpan Sign Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__onespan_sign_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=onespan_sign_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_onespan_sign"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("OneSpan Sign Settings & Accounts", level=2),
